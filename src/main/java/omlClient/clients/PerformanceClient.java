...
/**
 * Reading the performance topic of the OMLDM component.
 */
public class PerformanceClient {
    ...
    public static void main(String[] args) {
        ...
        ObjectMapper objectMapper = new ObjectMapper(); // An object mapper for deserializing the statistics records.
        ...
        if (args.length == 2)
            ...
            topic = KafkaConstants.PERFORMANCE_TOPIC_NAME;
            brokerList = KafkaConstants.PERFORMANCE_KAFKA_BROKERS;
        }
        ...
        try {
            ...
            kafkaConsumer = OMLDMConsumer.setConsumer(topic, brokerList, KafkaConstants.PERFORMANCE_GROUP_ID);
